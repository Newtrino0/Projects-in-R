...
H1B_numbers <- cbind(H1B_numbers, H1B_numbers$Inital_Approval/(H1B_numbers$Inital_Approval+H1B_numbers$Inital_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), H1B_numbers$Inital_Denial/(H1B_numbers$Inital_Approval+H1B_numbers$Inital_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), H1B_numbers$Continuing_Approval/(H1B_numbers$Inital_Approval+H1B_numbers$Inital_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), H1B_numbers$Continuing_Denial/(H1B_numbers$Inital_Approval+H1B_numbers$Inital_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial))
...
H1B_agg<-aggregate(H1B_numbers[2:9],by=list(H1B_numbers$Year), FUN=sum)
View(H1B_agg)

#H1B_numbers<-aggregate(H1B_numbers[2:5],by=list(H1B_numbers$Year), FUN=sum)

tsH1B<-ts(aggregate(H1B_numbers[2:5],by=list(H1B_numbers$Year), FUN=sum)$Continuing_Approval, start=2009,end=2022)
plot.ts(tsH1B)
