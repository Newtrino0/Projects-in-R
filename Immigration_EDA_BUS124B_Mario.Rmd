...
colnames(H1B_numbers)[1] <- "Year"
H1B_numbers <- cbind(H1B_numbers, H1B_numbers$Initial_Approval/(H1B_numbers$Initial_Approval+H1B_numbers$Initial_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), H1B_numbers$Initial_Denial/(H1B_numbers$Initial_Approval+H1B_numbers$Initial_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), H1B_numbers$Continuing_Approval/(H1B_numbers$Initial_Approval+H1B_numbers$Initial_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), H1B_numbers$Continuing_Denial/(H1B_numbers$Initial_Approval+H1B_numbers$Initial_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), (H1B_numbers$Initial_Approval+H1B_numbers$Continuing_Approval)/(H1B_numbers$Initial_Approval+H1B_numbers$Initial_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial), (H1B_numbers$Initial_Denial+H1B_numbers$Continuing_Denial)/(H1B_numbers$Initial_Approval+H1B_numbers$Initial_Denial+H1B_numbers$Continuing_Approval+H1B_numbers$Continuing_Denial))

colnames(H1B_numbers)[6]<-"IAppovals ratio"
colnames(H1B_numbers)[7]<-"IDenials ratio"
colnames(H1B_numbers)[8]<-"CApproval ratio"
colnames(H1B_numbers)[9]<-"CDenials ratio"
colnames(H1B_numbers)[10]<-"Approvals ratio"
colnames(H1B_numbers)[11]<-"Denials ratio"
